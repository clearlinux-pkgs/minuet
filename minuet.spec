...
%prep
%setup -q -n minuet-20.08.2
cd %{_builddir}/minuet-20.08.2
...
cp %{_builddir}/minuet-20.08.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/minuet/464c48ede3b2a4ea76b5f314f03213315f942c63
pushd clr-build
%make_install
popd
%find_lang minuet
