...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/minuet-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/minuet-24.12.3.tar.xz.sig
...
%setup -q -n minuet-24.12.3
cd %{_builddir}/minuet-24.12.3
pushd ..
cp -a minuet-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742420223
mkdir -p clr-build
pushd clr-build
