...
Version  : 22.04.2
Release  : 20
URL      : https://download.kde.org/stable/release-service/22.04.2/src/minuet-22.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/minuet-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/minuet-22.04.2.tar.xz.sig
...
%prep
%setup -q -n minuet-22.04.2
cd %{_builddir}/minuet-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654821929
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/minuet-22.04.2/COPYING %{buildroot}/usr/share/package-licenses/minuet/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/minuet-22.04.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/minuet/464c48ede3b2a4ea76b5f314f03213315f942c63
pushd clr-build
%make_install
popd
%find_lang minuet
