...
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/minuet-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/minuet-24.12.1.tar.xz.sig
...
%setup -q -n minuet-24.12.1
cd %{_builddir}/minuet-24.12.1
pushd ..
cp -a minuet-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736479209
mkdir -p clr-build
pushd clr-build
