...
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/minuet-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/minuet-22.12.2.tar.xz.sig
...
%prep
%setup -q -n minuet-22.12.2
cd %{_builddir}/minuet-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676865715
mkdir -p clr-build
pushd clr-build
